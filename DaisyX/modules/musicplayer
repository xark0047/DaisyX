...
__help__ = """
 ...
 MYSTICMUSIC plays plays music in your group's voice chat
 
 Assistant name >> @Mystic_assistant
...
*) If userbot joined enjoy music, If not add @Mystic_assistant to your group and retry
...
=>> More tools 🧑‍🔧
  ...
  /userbotjoin: Invite @Mystic_assistant Userbot to your chat
